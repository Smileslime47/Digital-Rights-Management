...
object Users : Table("drm_user") {
    ...
    fun <T : UpdateBuilder<Int>> getStatementBinder(user: User): Users.(statement: T) -> Unit = {
        it[id] = user.id
        it[permission_id] = user.permissionId
        it[username] = user.username ?: Constant.Global.NULL_PLACEHOLDER
        it[password] = user.password ?: Constant.Global.NULL_PLACEHOLDER
        it[nickname] = user.nickname ?: Constant.Global.NULL_PLACEHOLDER
        it[email] = user.email ?: Constant.Global.NULL_PLACEHOLDER
        it[phone_number] = user.phoneNumber ?: Constant.Global.NULL_PLACEHOLDER
    }
}